...
<<<<<<< Updated upstream:src/main/java/com/su/hydrangea/domain/region/outbound/VaccinateCovidClient.java
...
@FeignClient(url = "https://nip.kdca.go.kr", configuration = XmlConfiguration.class, name = "vaccinateCovidInformation")
public interface VaccinateCovidClient {
>>>>>>> Stashed changes:src/main/java/com/su/hydrangea/domain/region/quartz/outbound/VaccinateCovidInformation.java
